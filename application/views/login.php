...
<br>
    <div class="jumbotron">
                <form class="form-horizontal" role="form" action="<?php echo site_url('Access/check') ?>" method="post">
                <div class="form-group">
                <div class="input-group">
                <span class="input-group-addon"><span class="glyphicon glyphicon-envelope"></span></span>
                <input type="text" class="form-control" placeholder="Email" id="userid" name="userid" required autofocus autocomplete="off" value = 'super_testing'>
                </div>
                </div>
                <div class="form-group">
                <div class="input-group">
                <span class="input-group-addon"><span class="glyphicon glyphicon-lock"></span></span>
                <input type="password" class="form-control" placeholder="Password" id="password" name="password" value = '1234abcd' required>
                </div>
                </div>
                <div class="form-group">
