...
<head>
  ...
  <link rel="icon" type="image/png" href="<?php echo base_url('asset/dist/img/panda.png');?>" >
...
<div class="wrapper">
  ...
  <header class="main-header">
     <nav class="navbar navbar-static-top">
      ...
      <div class="pull-left">
        <a href="<?php echo site_url('#')?>" class="btn btn-default"><i class="fa fa-arrow-left"></i></a>
      </div>
...
<br>
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="col-md-6">
      <form action="<?php echo site_url('Email_controller/submit_email');?>" method='post'>

        <div class="form-group">
        Please Key Email : <input class="form-control" autocomplete="off" required id="email" name="email" value="" type="email" />
